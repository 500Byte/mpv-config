...
mp.add_key_binding(nil, "menu", function ()
    ...
    local menu = {
        ...
        {"音频轨道", "script-binding select/select-aid", audio_track_count > 1},
        {"视频轨道", "script-binding select/select-vid", video_track_count > 1},
        ...
        {"历史记录", "script-binding recentmenu/open", true},
